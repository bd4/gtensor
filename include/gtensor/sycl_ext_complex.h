...
//
// See also https://github.com/argonne-lcf/SyclCPLX. If/when this is included
// in the SYCL standard and widely available, we can remove this and adapt
...
namespace gt::backend::sycl::ext::cplx
{
...
#define _SYCL_EXT_CPLX_BEGIN_NAMESPACE_STD namespace gt::backend::sycl::ext::cplx {
